...
const EventPage = ({ eventData }) => {
  ...
  const backgroundImageUrl = gallery.find(item => item.placement === 'hero')?.image || 'https://images.unsplash.com/photo-1523580494863-6f3031224c94?q=80&w=2070&auto=format&fit=crop';
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {gallery && gallery.length > 0 && (
          <motion.section className="mb-16" variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-[#a0291f] font-poppins">📸 Event Gallery</h2>
